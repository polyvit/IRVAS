...
window.addEventListener("DOMContentLoaded", () => {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".decoration_slider", ".no_click", ".tab_content", "after_click");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const changeTabs = function (containerSelector, tabSelector, contentSelector, activeClass) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeTabs);
...
__webpack_require__.r(__webpack_exports__);
// Plan
// Функция определяет количество времени, оставшееся до дедлайна => принимает данные, вычисляет остаток, переводит его в дни-часы-минуты-секунды (getTimeRemaining)
// Функция, устанавливающая время. Она знает, в какие элементы устанавливать данные. Циклично при помощи интвервала запускает функцию, которая будет обновлять время
